...
function requester (url, method, id, params, cb) {
  if (!helper.check(id, 'string', '', 'ID is required', cb))
    this.api[method](url + id + '.json', params, cb);
}
//
// Module: Tweets
// ==============
...
Tweets.prototype.retweets = function(id, params, callback) {
  requester.call(this, '/statuses/retweets/', 'get', id, params, callback);
};
...
Tweets.prototype.show = function(id, params, callback) {
  requester.call(this, '/statuses/show/', 'get', id, params, callback);
};
...
Tweets.prototype.destroy = function(id, params, callback) {
  requester.call(this, '/statuses/destroy/', 'post', id , params, callback);
};
...
Tweets.prototype.retweet = function(id, params, callback) {
  requester.call(this, '/statuses/retweet/', 'post', id, params, callback);
};
